...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<chef-config>.freeze, ["= 17.10.0"])
    s.add_runtime_dependency(%q<chef-utils>.freeze, ["= 17.10.0"])
    ...
    s.add_runtime_dependency(%q<ohai>.freeze, ["~> 17.0"])
    s.add_runtime_dependency(%q<inspec-core>.freeze, ["~> 4.23"])
    s.add_runtime_dependency(%q<ffi>.freeze, [">= 1.5.0"])
    ...
    s.add_dependency(%q<chef-config>.freeze, ["= 17.10.0"])
    s.add_dependency(%q<chef-utils>.freeze, ["= 17.10.0"])
    s.add_dependency(%q<train-core>.freeze, ["~> 3.2", ">= 3.2.28"])
    s.add_dependency(%q<train-winrm>.freeze, [">= 0.2.5"])
    s.add_dependency(%q<license-acceptance>.freeze, [">= 1.0.5", "< 3"])
    ...
    s.add_dependency(%q<mixlib-shellout>.freeze, [">= 3.1.1", "< 4.0"])
    s.add_dependency(%q<mixlib-archive>.freeze, [">= 0.4", "< 2.0"])
    s.add_dependency(%q<ohai>.freeze, ["~> 17.0"])
    s.add_dependency(%q<inspec-core>.freeze, ["~> 4.23"])
    s.add_dependency(%q<ffi>.freeze, [">= 1.5.0"])
    s.add_dependency(%q<ffi-yajl>.freeze, ["~> 2.2"])
    s.add_dependency(%q<net-sftp>.freeze, [">= 2.1.2", "< 4.0"])
    s.add_dependency(%q<erubis>.freeze, ["~> 2.7"])
    s.add_dependency(%q<diff-lcs>.freeze, [">= 1.2.4", "!= 1.4.0", "< 1.6.0"])
    s.add_dependency(%q<ffi-libarchive>.freeze, ["~> 1.0", ">= 1.0.3"])
    s.add_dependency(%q<chef-zero>.freeze, [">= 14.0.11"])
    s.add_dependency(%q<chef-vault>.freeze, [">= 0"])
    ...
    s.add_dependency(%q<uuidtools>.freeze, [">= 2.1.5", "< 3.0"])
    s.add_dependency(%q<corefoundation>.freeze, ["~> 0.3.4"])
    s.add_dependency(%q<proxifier>.freeze, ["~> 1.0"])
    s.add_dependency(%q<aws-sdk-s3>.freeze, ["~> 1.91"])
    s.add_dependency(%q<aws-sdk-secretsmanager>.freeze, ["~> 1.46"])
    s.add_dependency(%q<vault>.freeze, ["~> 0.16"])
  end
end
