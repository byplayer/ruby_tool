...
Gem::Specification.new do |s|
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<chef-config>.freeze, ["= 17.9.18"])
    s.add_runtime_dependency(%q<chef-utils>.freeze, ["= 17.9.18"])
    ...
    s.add_dependency(%q<chef-config>.freeze, ["= 17.9.18"])
    s.add_dependency(%q<chef-utils>.freeze, ["= 17.9.18"])
    ...
    s.add_dependency(%q<diff-lcs>.freeze, [">= 1.2.4", "< 1.4.0"])
