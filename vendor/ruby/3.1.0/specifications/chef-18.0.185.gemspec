...
Gem::Specification.new do |s|
  ...
  s.required_ruby_version = Gem::Requirement.new(">= 3.0.3".freeze)
  ...
  if s.respond_to? :add_runtime_dependency then
    s.add_runtime_dependency(%q<chef-config>.freeze, ["= 18.0.185"])
    ...
    s.add_dependency(%q<chef-config>.freeze, ["= 18.0.185"])
    s.add_dependency(%q<chef-utils>.freeze, ["= 18.0.185"])
    s.add_dependency(%q<train-core>.freeze, ["~> 3.10"])
    s.add_dependency(%q<train-winrm>.freeze, [">= 0.2.5"])
    s.add_dependency(%q<train-rest>.freeze, [">= 0.4.1"])
    ...
    s.add_dependency(%q<ohai>.freeze, ["~> 18.0"])
    s.add_dependency(%q<inspec-core>.freeze, [">= 5"])
    s.add_dependency(%q<ffi>.freeze, [">= 1.15.5"])
    s.add_dependency(%q<ffi-yajl>.freeze, ["~> 2.2"])
    s.add_dependency(%q<net-sftp>.freeze, [">= 2.1.2", "< 5.0"])
    ...
    s.add_dependency(%q<unf_ext>.freeze, [">= 0.0.8.2"])
